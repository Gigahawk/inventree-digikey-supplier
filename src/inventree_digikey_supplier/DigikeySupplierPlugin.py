...
class DigikeySupplierPlugin(SupplierMixin, InvenTreePlugin):
    ...
    NAME = "DigikeySampleSupplierPlugin"
    SLUG = "digikeysamplesupplier"
    TITLE = "Sample DigiKey supplier plugin"
    ...
    def __init__(self):
        ...
        self.sample_data = []
        for material in ["DkSteel", "DkAluminium", "DkBrass"]:
                    ...
                    self.sample_data.append(
                        {
                            ...
                            "description": f"DIGIKEY This is a sample part description demonstration purposes for the {size}x{length} {material} bolt.",
                            "price": {
                                1: [1.0, "EUR"],
                                10: [0.9, "EUR"],
                                100: [0.8, "EUR"],
